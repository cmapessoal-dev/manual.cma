(function(){
  ...
  function criar(){
    ...
    const s=document.createElement('section');s.id='apurador-ponto';s.className='manual-section hidden fade-in cma-calculadora-padrao';s.innerHTML=`
      ...
      <label class="cma-ap-noturno-opcao"><input id="cma-ap-noturno" type="checkbox"><span><strong>Apurar adicional noturno</strong><small>Quantifica as horas urbanas entre 22h e 5h, considerando a hora reduzida de 52min30s.</small></span></label>
  ...
  window.CMAApuradorPonto={minutos,duracao,formatar,calcularNoturno,analisarDia,criar,versao:'1.3'};
