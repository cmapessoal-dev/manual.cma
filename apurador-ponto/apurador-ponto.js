(function(){
  ...
  function criar(){
    ...
    const secoesAmplas=['apurador-ponto','custo-empregado','calculadora-folha','calculadora-rescisao'].map(id=>document.getElementById(id)).filter(Boolean),largura=()=>document.getElementById('manual-conteudo')?.classList.toggle('cma-ferramenta-ampla',secoesAmplas.some(sec=>sec.classList.contains('active')&&!sec.classList.contains('hidden')));
