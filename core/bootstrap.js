(function(){
  ...
  const modulos=[
    ...
    ['calculadora-tempo-parcial','calculadora-tempo-parcial/calculadora-tempo-parcial.js'],
    ...
    ['padrao-calculadoras','ferramentas/padrao-calculadoras.js'],
