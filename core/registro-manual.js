(function(){
  ...
  const paginas=[
    ...
    {id:'calculadora-rescisao',nome:'Simulador de Rescisão',grupo:'ferramentas',ferramenta:{categoria:'rescisao',titulo:'Simulador de Rescisão',descricao:'Base inicial de saldo, férias, 13º e aviso-prévio.',icone:'<path d="M6 2h9l4 4v16H6z"/><path d="M14 2v5h5M9 12h6M9 16h6"/>',tag:'Novo'}},
