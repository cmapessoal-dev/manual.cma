(function(){
  ...
  const paginas=[
    ...
    {id:'calculadora-rescisao',nome:'Simulador de Rescisão',grupo:'ferramentas',ferramenta:{categoria:'rescisao',titulo:'Simulador de Rescisão',descricao:'Saldo, férias, 13º e aviso conforme a modalidade do desligamento.',icone:'<path d="M6 2h9l4 4v16H6z"/><path d="M14 2v5h5M9 12h6M9 16h6"/>',tag:'Novo'}},
    ...
    {id:'apurador-ponto',nome:'Apurador de Ponto',grupo:'ferramentas',ferramenta:{categoria:'jornada',titulo:'Apurador de Ponto',descricao:'Apuração mensal de horas extras a 50% e 100%, período noturno, atrasos e faltas.',icone:'<rect x="3" y="4" width="18" height="17" rx="2"/><path d="M8 2v4M16 2v4M3 9h18M8 13h3M8 17h6"/>'}},
  ...
  const categoriasFerramentas=[
    ...
    {id:'rescisao',titulo:'Rescisão',sub:'Simulações e conferências das verbas de desligamento.'},
