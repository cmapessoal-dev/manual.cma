(function(){
  ...
  const paginas=[
    ...
    {id:'apurador-ponto',nome:'Apurador de Ponto',grupo:'ferramentas',ferramenta:{categoria:'jornada',titulo:'Apurador de Ponto',descricao:'Conferência mensal de marcações, atrasos e saldo de jornada.',icone:'<rect x="3" y="4" width="18" height="17" rx="2"/><path d="M8 2v4M16 2v4M3 9h18M8 13h3M8 17h6"/>'}},
