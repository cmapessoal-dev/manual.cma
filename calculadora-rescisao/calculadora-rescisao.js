(function(){
  ...
  function calcularPorModalidade({modalidade='sem_justa',formaAviso='indenizado',salario=0,medias=0,diasSaldo=0,avosFerias=0,periodosVencidos=0,avosDecimo=0,diasAviso=0,desligamento='',fimContrato='',dependentes=0,pensaoSaldo=0,pensaoDecimo=0,valeTransporte=0,planoSaude=0,alimentacao=0,outrosDescontos=0}={}){
  ...
  window.CMACalculadoraRescisao={calcularBase,calcularTributos,calcularPorModalidade,calcularAutomaticos,calcularFeriasPorDatas,contarAvosDecimo,contarAvosFerias,diasAvisoAutomaticos,recalcular,criar,versao:'0.6'};
