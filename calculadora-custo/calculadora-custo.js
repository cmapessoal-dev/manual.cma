(function(){
  ...
  function recalcular(){
    ...
    if(caixa)caixa.innerHTML=
      ...
      (temAlim?linha('Vale-alimentação / refeição — valor informado',alimBruto)+linha('(-) Participação do empregado',-descontoAlim,'cma-custo-desconto')+linha('Custo do benefício para a empresa',custoAlim,'cma-custo-sub'):'')+
      (temVT?linha('Vale-transporte — valor informado',vtBruto)+linha('(-) Desconto do empregado',-descontoVT,'cma-custo-desconto')+linha('Custo do VT para a empresa',custoVT,'cma-custo-sub'):'')+
      (plano?linha('Plano de saúde',plano):'')+
      (outros?linha('Outros benefícios',outros):'')+
      linha('FGTS sobre salário',fgtsSalario)+
      (regime==='nao-simples'?linha('INSS + SAT + Terceiros',encargosFolha):'')+
    ...
    if(prov)prov.innerHTML=
      ...
      linha('FGTS sobre férias + 1/3',fgtsFerias)+
      linha('13º salário',decimo)+
      linha('FGTS sobre 13º',fgtsDecimo)+
      linha('Aviso-prévio',aviso)+
      linha('FGTS sobre aviso-prévio',fgtsAviso)+
      linha('Provisão da multa do FGTS',multaFgts)+
      (regime==='nao-simples'?linha('INSS + SAT + Terceiros sobre provisões',encargosProv):'')+
        ...
        <div class="cma-custo-resultados">
          ...
          <div class="cma-custo-card">
            ...
            <div id="exp-custo-calculo" class="hidden cma-custo-formulas">
              <div><strong>Férias:</strong> salário base ÷ 12. O valor representa uma provisão mensal para formar, ao longo de 12 meses, a remuneração correspondente às férias.</div>
              <div><strong>1/3 de férias:</strong> valor mensal das férias ÷ 3.</div>
              <div><strong>13º salário:</strong> salário base ÷ 12. Cada mês representa, em regra, 1/12 do 13º salário anual.</div>
              <div><strong>FGTS:</strong> aplicação de 8% sobre as parcelas consideradas na estimativa.</div>
              <div><strong>Aviso-prévio:</strong> salário base ÷ 12, utilizado como provisão mensal estimada.</div>
