(function(){
  ...
  function instalarEstilo(){
    ...
    const st=document.createElement('style');st.id='cma-central-ferramentas-style';st.textContent=`
      .cma-voltar-central{display:inline-flex;align-items:center;gap:6px;margin:0 0 14px;padding:7px 10px;border:0;border-radius:8px;background:#f1f5f9;color:#475569;font-size:12px;font-weight:800;cursor:pointer}.cma-voltar-central:hover{background:#e2e8f0;color:#172554}
      .cma-central-hero{display:flex;align-items:center;justify-content:space-between;gap:24px;margin-bottom:28px;padding:24px 26px;border-radius:18px;background:linear-gradient(135deg,#061a46,#0b347f);color:#fff;box-shadow:0 14px 30px rgba(15,23,42,.14)}.cma-central-hero>div:first-child{max-width:650px}.cma-central-hero span{display:block;margin-bottom:5px;color:#fbbf24;font-size:11px;font-weight:900;letter-spacing:.1em;text-transform:uppercase}.cma-central-hero h3{margin:0;font-size:28px;font-weight:850;line-height:1.1;color:#fff}.cma-central-hero p{margin:8px 0 0!important;color:#dbeafe!important;font-size:13.5px!important;line-height:1.55!important;text-align:left!important}.cma-central-hero-marca{display:grid;width:58px;height:58px;place-items:center;border:1px solid rgba(255,255,255,.18);border-radius:16px;background:rgba(255,255,255,.08);color:#fff;flex:0 0 58px}.cma-central-hero-marca svg{width:28px;height:28px}
      .cma-central-grupos{display:flex;flex-direction:column;gap:24px}.cma-central-grupo{margin:0}.cma-central-grupo-titulo{margin-bottom:10px;padding-bottom:8px;border-bottom:1px solid #e2e8f0}.cma-central-grupo-titulo h4{margin:0;color:#172554;font-size:16px;font-weight:850}.cma-central-grupo-titulo p{margin:2px 0 0!important;color:#94a3b8!important;font-size:11.5px!important;line-height:1.4!important;text-align:left!important}
      .cma-central-cards{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.cma-central-card{display:grid;grid-template-columns:38px minmax(0,1fr) 18px;align-items:center;gap:10px;min-height:88px;padding:13px 12px;border:1px solid #e5eaf1;border-radius:11px;background:#fff;text-align:left;cursor:pointer;transition:.16s ease}.cma-central-card:hover{border-color:#bfdbfe;background:#f8fbff;box-shadow:0 6px 16px rgba(15,23,42,.055);transform:translateY(-1px)}.cma-central-card-icone{display:grid;width:36px;height:36px;place-items:center;border-radius:9px;background:#eff6ff;color:#1e3a8a}.cma-central-card-icone svg{width:18px;height:18px}.cma-central-card-conteudo{min-width:0}.cma-central-card-titulo{display:flex;align-items:center;gap:6px;color:#172554;font-size:12.5px;font-weight:850;line-height:1.25}.cma-central-card-titulo em{padding:2px 5px;border-radius:999px;background:#fef3c7;color:#92400e;font-size:8px;font-style:normal;font-weight:900;text-transform:uppercase;letter-spacing:.04em}.cma-central-card-texto{display:block;margin-top:4px;color:#64748b;font-size:10.5px;line-height:1.35}.cma-central-card-seta{color:#94a3b8;font-size:20px;line-height:1;text-align:right}.cma-central-card:hover .cma-central-card-seta{color:#1d4ed8}
      @media(max-width:1050px){.cma-central-cards{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){.cma-central-hero{padding:20px;border-radius:14px}.cma-central-hero-marca{display:none}.cma-central-hero h3{font-size:24px}.cma-central-cards{grid-template-columns:1fr}.cma-central-card{min-height:76px}.cma-central-grupos{gap:20px}}
